...
export default function CompanyMedia() {
  ...
  useEffect(() => {
    const fetchUserPosts = async () => {
      ...
      try {
        ...
        // Company uses the same post API since posts are owned by the user account id
        const response = await axios.get(`http://localhost:5000/api/posts/user/${userId}`, {
          headers: { Authorization: `Bearer ${token}` }
        });

        // Extract all media files from company posts
        const extracted = [];
        ...
        console.error('Failed to fetch company media:', err);
  ...
  return (
    <div className="company-media-container" style={{ padding: '10px 0' }}>
      <div className="card border-0 shadow-sm p-4" style={{ borderRadius: '12px', backgroundColor: '#fff', minHeight: '520px' }}>
        <div className="d-flex align-items-center justify-content-between border-bottom pb-3 mb-4">
          <div>
            <h4 className="fw-bold mb-1 text-dark" style={{ fontFamily: 'Inter, sans-serif' }}>
              <i className="far fa-images text-primary me-2.5"></i> Company Media Library
            </h4>
            <p className="text-muted small mb-0">Browse and manage all the photos and videos uploaded by your company.</p>
          </div>
        </div>
        ...
        <div className="d-flex gap-2 mb-4 border-bottom pb-2">
          <button
            ...
            style={{ borderRadius: '8px', fontSize: '0.85rem', backgroundColor: activeTab === 'all' ? '#1976d2' : undefined }}
          >
          ...
          <button
            ...
            style={{ borderRadius: '8px', fontSize: '0.85rem', backgroundColor: activeTab === 'photos' ? '#1976d2' : undefined }}
          >
          ...
          <button
            ...
            style={{ borderRadius: '8px', fontSize: '0.85rem', backgroundColor: activeTab === 'videos' ? '#1976d2' : undefined }}
          >
        ...
        {loading ? (
          <div className="text-center py-5">
            ...
            <p className="text-muted mt-2">Loading your library...</p>
          </div>
        ) : error ? (
          ...
          <div className="text-center py-5 text-muted border rounded-3 bg-light" style={{ borderStyle: 'dashed' }}>
            ...
            <h6 className="fw-semibold">No media assets found</h6>
            <p className="small mb-0">Images or videos you upload when sharing articles or job posts will appear here.</p>
          </div>
        ) : (
          /* Media Grid */
            ...
            >
              ...
              <div className="d-flex align-items-center justify-content-between border-top bg-light" style={{ padding: '16px 20px' }}>
                <span className="text-muted small">
                  Uploaded on: {new Date(lightboxMedia.createdAt).toLocaleDateString()}
                </span>
                <button
                  type="button"
                  onClick={() => {
              ...
              <div className="p-4" style={{ overflowY: 'auto', flexGrow: 1 }}>
                ...
                <div className="d-flex align-items-center justify-content-between border-top border-bottom py-1.5 mb-3">
                  <button
                    ...
                    style={{ color: activePostDetail.is_liked ? '#1976d2' : '#64748b', fontSize: '0.85rem', fontWeight: '600' }}
                  >
                ...
                <div>
                  ...
                  <form onSubmit={handleModalAddComment} className="d-flex gap-2 mb-3">
                    ...
                    <button
                      ...
                      style={{ fontSize: '0.8rem', backgroundColor: '#1976d2' }}
                    >
